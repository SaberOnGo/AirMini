...
// PM25_SET  ->  PA8
#define PM25_SET_Pin          GPIO_Pin_8
#define PM25_SET_PORT         GPIOA
#define PM25_SET_Open()       SET_REG_32_BIT(PM25_SET_PORT->BSRR, PM25_SET_Pin)  // 输出高, GPIOx->BSRR = GPIO_Pin;
#define PM25_SET_Close()      SET_REG_32_BIT(PM25_SET_PORT->BRR,  PM25_SET_Pin)  // 输出低  GPIOx->BRR = GPIO_Pin;
#define PM25_SET_RCC_APBPeriphClockCmdEnable()    SET_REG_32_BIT(RCC->APB2ENR, RCC_APB2Periph_GPIOA)   // PCLK2 = HCLK = 48MHz
...
// LCD_Power_Ctrl -> PA6  IO 输出高电平导通
#define LCD_Power_Ctrl_Pin      GPIO_Pin_6
...
#define LCD_Power_Ctrl_RCC_APBPeriphClockCmdEnable()       SET_REG_32_BIT(RCC->APB2ENR, RCC_APB2Periph_GPIOA)   // PCLK2 = HCLK = 48MHz
...
#define LED_Blue_RCC_APBPeriphClockCmdEnable()       SET_REG_32_BIT(RCC->APB2ENR, RCC_APB2Periph_GPIOD)    // PCLK2 = HCLK = 48MHz
...
#define LED_Green_RCC_APBPeriphClockCmdEnable()       SET_REG_32_BIT(RCC->APB2ENR, RCC_APB2Periph_GPIOD)   // PCLK2 = HCLK = 48MHz
