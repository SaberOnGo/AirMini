...
uint32_t Data_Buffer[BULK_MAX_PACKET_SIZE * 4 * 4]; /* 注意数据类型为32位长度，所以buffer为4096 bytes*/
#elif (SPI_FLASH_SECTOR_SIZE <= 1024L)
uint32_t Data_Buffer[BULK_MAX_PACKET_SIZE * 4]; /* 注意数据类型为32位长度，所以buffer为4096 bytes*/
#else
