...
#define temp_RATIO                         0.01
#define temp_ADDITION                      -30
#define temp_MIN                           0
#define temp_MAX                           18000
